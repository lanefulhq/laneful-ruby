...
begin
  email = Laneful::Email::Builder.new
    ...
    .text_content("Hi! This is a test email sent using the Laneful Ruby SDK. The SDK is working perfectly!")
    .tag("ruby-sdk-test")
    .build
...
begin
  ...
  email = Laneful::Email::Builder.new
    ...
    HTML
    .text_content("Ruby SDK Test Successful! Hello! This email was sent using the Laneful Ruby SDK with modern Ruby features including frozen string literals, keyword arguments, safe navigation operator, and enhanced exception handling. This email has tracking enabled for opens and clicks.")
    .tracking(tracking)
    .tag("html-cc-test")
    .build
